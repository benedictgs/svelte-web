...
<section id={id} class="flex justify-center bg-cover bg-top bg-no-repeat bg-fixed bg-[url('$lib/media/background-hero-blur.webp')] pt-4 ">
    <div in:fly="{{y:200, duration:500}}" class="w-full lg:max-w-screen-lg mb-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 lg:gap-10 bg-black/50  mx-3 p-6 md:px-6 rounded-xl">
                <div in:fade={{delay:600,duration:1000}} class="flex flex-col justify-between sm:max-w-sm row-span-2 lg:col-span-1">
                    <div class="flex flex-row hover:animate-pulse">
                    ...
                    <picture class=" hidden sm:grid justify-center hover:animate-pulse">
                ...
                <div>
                    ...
                    <ul in:fade="{{delay:1000,duration:1000}}" class="">
                        {#each stats as stat}
                ...
                <div class="flex flex-col">
                    ...
                    <div in:fade="{{delay:1000,duration:1000}}" class=" min-h-[10rem] hover:animate-pulse"><RadarContainer/></div>
                </div>
                <div class="sm:col-span-2 flex flex-col">
                    <hr class=" my-3  border-gray-600">
                    <h3 in:fade="{{delay:600,duration:1000}}" class="font-bebas text-xl mb-3 hover:animate-pulse">Timeline of Performance</h3>
                    <div in:fade="{{delay:1000,duration:1000}}" class="min-h-[10rem] hover:animate-pulse"><LineAreaContainer/></div>
                </div>
